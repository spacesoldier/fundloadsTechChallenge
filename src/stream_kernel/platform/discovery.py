...
def platform_discovery_modules() -> list[str]:
    ...
    return [
        ...
        "stream_kernel.execution.orchestration.lifecycle.leaf.command.finalization_service",
        ...
        "stream_kernel.execution.orchestration.lifecycle.leaf.runtime.session_state_service",
