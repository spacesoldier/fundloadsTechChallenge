...
_DEFAULT_PAYLOAD_LANES: dict[str, str] = {
    "stream_kernel.platform.services.runtime.control_plane_events.ControlPlaneLeafHelloEvent": EXECUTION_IPC_LANE_CONTROL,
    "stream_kernel.platform.services.runtime.control_plane_events.ControlPlaneLeafDiscoveryAckEvent": EXECUTION_IPC_LANE_CONTROL,
    "stream_kernel.platform.services.runtime.control_plane_events.ControlPlaneLeafConfigAckEvent": EXECUTION_IPC_LANE_CONTROL,
    "stream_kernel.platform.services.runtime.control_plane_events.ControlPlaneLeafStopAckEvent": EXECUTION_IPC_LANE_CONTROL,
