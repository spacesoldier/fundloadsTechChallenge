...
def build_root_static_system_steps(
    *,
    ...
    root_leaf_event_log_bridge: object,
    root_log_dispatch: object,
    ...
    return [
        ...
        StepSpec(name="system.cp.root_leaf_event_log_bridge", step=root_leaf_event_log_bridge),
        StepSpec(name="system.cp.log_dispatch", step=root_log_dispatch),
